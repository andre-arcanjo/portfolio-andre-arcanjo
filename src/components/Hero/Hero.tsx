                ...
                <section className="min-h-[80vh] text-[#E5E7E8] flex items-center justify-around">
                    <div className="max-w-120 text-content space-y-8">
                        ...
                        <div className="flex gap-10 font-medium">
                            <a href="#projetos" target="_blank" rel="noopener noreferrer" className="h-10 w-32 flex items-center justify-center bg-[#7C3AED] rounded-lg hover:bg-[#A78BFA] hover:scale-105 transition-all">Ver Projetos</a>
                            <a href="https://github.com/andre-arcanjo" target="_blank" rel="noopener noreferrer" className="h-10 w-32 flex items-center justify-center bg-[#7C3AED] rounded-lg hover:bg-[#A78BFA] hover:scale-105 transition-all">GitHub</a>
                        </div>
                    </div>
                    <div>
