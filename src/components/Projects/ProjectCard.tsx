  ...
  return (
    <>
      {projects.map((project) => (
        <div
          key={project.title}
          className="h-[450px] w-[360px] md:h-[520px] md:w-[520px] flex flex-col items-center justify-center max-w-lg space-y-5 border rounded-md hover:scale-105 transition-transform"
        >
