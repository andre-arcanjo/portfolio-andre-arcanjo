...
export const ProjectCard = ({ project }: ProjectCardProps) => {
  return (
    <div
      className={`h-auto min-h-128 py-6 w-[90%] shrink-0 md:shrink md:w-130 md:h-130 md:min-h-0 md:py-0 flex flex-col items-center justify-center max-w-lg space-y-5 border rounded-md hover:scale-105 transition-transform snap-center ${
        project.featured
          ? 'border-button shadow-[0_0_30px_rgba(124,58,237,0.25)]'
          : ''
      }`}
    >
      <h3 className="px-4 text-center font-semibold">{project.title}</h3>
