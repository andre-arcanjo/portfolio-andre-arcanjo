        ...
        <div className="max-w-90 md:max-w-120 flex flex-col items-center text-center space-y-15">
          ...
          <div className="space-y-4">
            <p className="text-sm md:text-base">
              ...
              contabilidade e apaixonado por tecnologia desde cedo. Em 2024
              decidi seguir o caminho da programação de forma profissional,
              iniciando meus estudos e desenvolvimento de projetos próprios.
            </p>
            <p className="text-sm md:text-base">
              Atualmente estudo JavaScript, React e boas práticas de
              desenvolvimento Front-End, sempre buscando criar interfaces
              modernas, funcionais e responsivas. Acredito no aprendizado
              contínuo e na prática como principal forma de evolução.
            </p>
            <p className="text-sm md:text-base">
