...
export const Contact = () => {
  return (
    <>
      <section
        id="contact"
        className="text-[#E5E7E8] min-h-screen space-y-16 md:space-y-24 flex flex-col justify-center items-center"
      >
        ...
        <div className="text-center text-sm md:text-base max-w-90 md:max-w-120 space-y-2">
          ...
          <p>
            Se quiser conversar sobre vagas ou projetos, será um prazer falar
            com você!
          </p>
        </div>
        <div className="flex flex-wrap justify-center gap-5">
          <a
            className="w-32 flex items-center justify-center gap-2 bg-[#7C3AED] px-3 py-1.5 md:px-4 md:py-2 rounded-lg hover:bg-[#A78BFA] hover:scale-105 transition-all"
